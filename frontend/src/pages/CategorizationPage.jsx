...
import { Tag, CheckCircle, ArrowRight, ChevronDown } from 'lucide-react';
...
export default function CategorizationPage() {
  ...
  const categoryEmojis = {
    ...
    Groceries: '🥦', Utilities: '⚡', Health: '💊', Education: '📚'
  };
      ...
      <div className="w-full max-w-xl">
        ...
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <p className="mt-3 text-gray-600 dark:text-gray-400 font-medium">
            AI matched this to <span className="font-bold text-[#C68346]">Food</span>
          </p>
        </div>
        ...
        <div className="glass-panel p-6 mb-10 animate-fade-in-up delay-100">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white tracking-wide">Zomato</h3>
                <p className="text-[11px] font-bold tracking-widest uppercase text-gray-500 mt-1">₹340 • 16 Mar 2026</p>
              </div>
            </div>
        ...
        <div className="relative mb-10 animate-fade-in-up delay-200">
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-6 py-4 rounded-xl glass-panel text-gray-900 dark:text-white text-base font-bold tracking-wide hover:border-[#C68346]/50 transition-all shadow-sm"
          >
            <div className="flex items-center gap-4">
              <span className="text-xl">{categoryEmojis[selectedCategory]}</span>
          ...
          {isOpen && (
            <div className="absolute z-10 w-full mt-2 bg-white dark:bg-[#111111] rounded-xl border border-gray-200 dark:border-white/10 shadow-lg overflow-hidden py-2">
              {categories.map((cat) => (
                <button
                  key={cat}
